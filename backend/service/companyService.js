const { sequelize, Company, Companyx } = require("../models");
...
exports.updateCompany = async (id, companyData) => {
    ...
    try {
        ...
        const [affectedRows] = await Company.update(mainData, { where: { id }, transaction: t });
...
exports.deleteCompany = async (id) => {
    ...
    try {
        ...
        await Companyx.destroy({ where: { companyId: company.companyId }, transaction: t });
