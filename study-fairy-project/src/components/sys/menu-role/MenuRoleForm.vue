  ...
  <section class="card-section">
    ...
    <form @submit.prevent="emit('submit')">
      <div class="form-grid">
        <div class="form-group">
          ...
          <select
            ...
            @change="updateValue('roleId', $event.target.value)"
            required
        ...
        <div class="form-group">
          ...
          <select
            id="menuId"
            :value="modelValue.menuId"
            @change="updateValue('menuId', $event.target.value)"
            required
            :disabled="isEditMode || isSubmitting"
          >
        ...
        <div class="form-group">
          ...
          <select
            id="useYn"
            :value="modelValue.useYn"
            @change="updateValue('useYn', Number($event.target.value))"
      ...
      <button
        type="submit"
        class="btn-primary"
        :disabled="isSubmitting || !modelValue.roleId || !modelValue.menuId"
      >
        {{
