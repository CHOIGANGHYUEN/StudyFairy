    ...
    <form @submit.prevent="emit('submit')" class="registration-form">
      <div class="form-grid">
        <div class="form-group">
          <label>언어 *</label>
          <select :value="formData.langu" @input="updateForm('langu', $event.target.value)" required>
            <option
        ...
        <div class="form-group">
          ...
          <select
            ...
            @input="updateForm('menuLevel', Number($event.target.value)); updateForm('parentMenuId', '')"
            required
          >
        ...
        <div class="form-group full-width">
          <label>메뉴명 *</label>
          <input type="text" :value="formData.menuNm" @input="updateForm('menuNm', $event.target.value)" required />
        </div>
